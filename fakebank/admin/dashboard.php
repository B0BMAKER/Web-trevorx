        ...
        <div class="card" style="height: 30rem;">
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <input type="text" class="form-control" id="sendFrom" name="sendFrom" placeholder="Bank Account Number" required>
                    <br>
                    <label for="sendTo">Send To</label>
                    <input type="text" class="form-control" id="sendTo" name="sendTo" placeholder="Bank Account Number" required>
                    <br>
                    <label for="sendTotal">Account to send in RUPIAH</label>
                    <input type="text" class="form-control" id="sendTotal" name="sendTotal" placeholder="Amount of Money" required>
                    <br>
