...
if ( isset($_POST["submit"]) ) {
   ...
   if ($result) {
    ...
    Swal.fire({ title: `Mantap!`,
                ...
                icon: `success`,
                footer: `<a href='dashboard' style='padding: 10px; background-color: aqua; color: white; border: box-shadow: 0 0 0 3px transparent; border-radius: 10px;' class='btn btn-primary'><i class='fa-solid fa-play'></i> Continue</a>`
