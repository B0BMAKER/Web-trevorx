            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="" method="POST">
                        <input type="text" name="nama" placeholder="Judul" class="form-control" value="<?= $result["nama"] ?>">
                        <br>
                        <br>
                        <input type="text" name="deskripsi" placeholder="Deskripsi" class="form-control" value="<?= $result["deskripsi"] ?>">
                        <br>
                        <br>
                        <textarea name="pesan" cols="30" rows="50" placeholder="Paragraf" class="form-control"><?= $result["pesan"] ?></textarea>
                        <br>
                        <br>
