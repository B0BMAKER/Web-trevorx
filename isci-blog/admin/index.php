...
<body>
  ...
  <nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="">I.S.C.I Blog </a>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form">
              <div class="container">
                ...
                <form action="" method="POST">
                  <input type="text" name="nama" placeholder="Judul" class="form-control" required>
                  <br>
                  <br>
                  <input type="text" name="deskripsi" placeholder="Deskripsi" class="form-control" required>
                  <br>
                  <br>
                  <textarea name="pesan" cols="30" rows="50" placeholder="Paragraf" class="form-control" required></textarea>
                  <br>
                  <br>
            ...
            if (isset($_POST["submit"])) {
              ...
              $query = mysqli_query($koneksi, "INSERT INTO user VALUES ('', '$nama', '$pesan', '$deskripsi', '$waktu') ");
